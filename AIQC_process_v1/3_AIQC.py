        ...
        for f in sorted(files):
            if f.endswith('.csv'):
               ...
               if switch==0:
                  ...
                  inf.insert(3,'T_new',glm_t_pred_new,True)
                  inf.insert(5,'RH_new',glm_rh_pred_new,True)
                  inf.insert(14,'q_new',glm_q_pred_new,True)
               ...
               if switch==1:
                  ...
                  inf.insert(3,'T_new',glm_t_norh_pred_new)
                  inf.insert(5,'RH_new',glm_rh_norh_pred_new,True)
                  inf.insert(14,'q_new',glm_q_norh_pred_new,True)
